...
function swapImages (theme) {
    ...
    if(theme === 'theme-night') {
        buttonSearch.style.backgroundImage = "url(../gifos-ver2/assets/icon-search_white.svg)";
        buttonCreate.src = "../gifos-ver2/assets/button-crear-gifo_white.svg";
        ...
        buttonSearch.style.backgroundImage = "url(../gifos-ver2/assets/icon-search.svg)";
        buttonCreate.src = "../gifos-ver2/assets/button-crear-gifo.svg";
